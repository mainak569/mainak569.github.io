...
export default class Clock extends Component {
    constructor() {
        ...
        this.state = {
            hour_12: true,
            // filled in on mount: the page is pre-rendered at build time, and rendering that
            // moment's time would never match the visitor's clock (React hydration error #425)
            current_time: null
        };
    }
